...
static const device_config_t ms6117_config[] = {
    // clang-format off
    {
        ...
        .bios           = {
            {
                .name          = "American Megatrends Inc. (071595) - Revision 2.0 (RM PC-6300 Accelerator)",
                .internal_name = "ms6117ami",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG Viglen OEM (W6117V1) - Revision 1.5",
                .internal_name = "ms6117vgl",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
            ...
            {
                .name          = "Award Modular BIOS v4.51PG FSC OEM (W6117F1) - Revision 1.4",
                .internal_name = "ms6117fsc",
                .bios_type     = BIOS_NORMAL, 
                .files_no      = 1,
                .local         = 0,
                .size          = 131072,
...
machine_at_ms6117_init(const machine_t *model)
{
    ...
    device_add(&piix4_device);
    device_add_params(&w83977_device, (void *) (W83977TF | W83977_AMI | W83977_NO_NVR));
    device_add(&sst_flash_29ee011_device);
    spd_register(SPD_TYPE_SDRAM, 0xF, 256);
    device_add(&lm78_device); /* no reporting in BIOS */
...
int
machine_at_pbmauip_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear_combined2("roms/machines/pbmauiplus/P11-0012.BIO",
                                     "roms/machines/pbmauiplus/P11-0012.BI1",
                                     "roms/machines/pbmauiplus/P11-0012.BI2",
                                     "roms/machines/pbmauiplus/P11-0012.BI3",
                                     "roms/machines/pbmauiplus/BIOS.REC",
                                     0x3a000, 128);
