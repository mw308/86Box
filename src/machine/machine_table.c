...
const machine_t machines[] = {
    ...
    {
        .name              = "[i430FX] Intel Advanced/HL (Hillary)",
        .internal_name     = "hillary",
        .type              = MACHINE_TYPE_SOCKET5,
        .chipset           = MACHINE_CHIPSET_INTEL_430FX,
        .init              = machine_at_hillary_init,
        .p1_handler        = machine_generic_p1_handler,
        .gpio_handler      = NULL,
        .available_flag    = MACHINE_AVAILABLE,
        .gpio_acpi_handler = NULL,
        ...
        .fdc_device               = NULL,
        .sio_device               = NULL,
        .vid_device               = &gd5434_onboard_pci_device_2mb,
        .snd_device               = NULL,
        .net_device               = NULL
    },
    /*
    ...
    {
        .name              = "[ALi ALADDiN V] Packard Bell FR510",
        .internal_name     = "fr510",
        .type              = MACHINE_TYPE_SOCKETS7,
        .chipset           = MACHINE_CHIPSET_ALI_ALADDIN_V,
